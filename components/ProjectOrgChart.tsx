  ...
  return (
    <div className="bg-white rounded-[3rem] border border-slate-200 shadow-sm p-10 md:p-16 animate-in fade-in zoom-in duration-500 overflow-x-auto">
      <header className="mb-16 text-center">
        ...
        <p className="text-slate-500 text-sm font-medium uppercase tracking-widest">Struktur & Flödesschema</p>
      </header>
      ...
      <div className="flex flex-col items-center min-w-[800px]">
        ...
        {pm && (
          <div className="relative">
            <EditableNode node={pm} onUpdate={handleUpdateNode} color="bg-blue-600" text="text-white" scale={1.1} />
      ...
      <footer className="mt-20 pt-10 border-t border-slate-50 flex justify-between items-center text-slate-400">
         ...
         <button className="text-[10px] font-black uppercase text-blue-600 hover:scale-105 transition-transform">+ Lägg till nod</button>
      </footer>
    </div>
  );
};
