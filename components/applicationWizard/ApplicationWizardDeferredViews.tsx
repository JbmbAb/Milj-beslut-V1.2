...
export const LocationAuditStep: React.FC<LocationAuditStepProps> = ({
  ...
  <section className="min-h-[560px] space-y-8 p-10 md:p-16">
    <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-600">
          Ange koordinater och kor verkliga publika audits. Resultatet ar beslutsstod och maste alltid granskas
          manuellt.
        </p>
      </div>
    ...
    <div className="flex flex-wrap gap-3">
      <button
        type="button"
        onClick={onUseSguDemo}
        className="rounded-full border border-slate-300 px-4 py-2 text-[11px] font-black uppercase tracking-[0.14em] text-slate-700"
      >
        SGU-demo
      </button>
      <button
        type="button"
        onClick={onUseStockholmDemo}
        className="rounded-full border border-slate-300 px-4 py-2 text-[11px] font-black uppercase tracking-[0.14em] text-slate-700"
      >
        Stockholm-demo
      </button>
    ...
    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
      <AuditScope
        ...
        description="NVR och Natura 2000 mot lokal PostGIS eller livefallback."
      />
      <AuditScope
        title="SGU georisk"
        icon="fa-mountain"
    ...
    <div className="rounded-3xl border border-amber-200 bg-amber-50 p-5 text-sm text-amber-800">
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mt-2">
            Korningen genererar beslutsstod. Slutlig bedomning, avgransning och eventuell inskickning gor manniska
  ...
  <section className="min-h-[560px] space-y-8 p-10 md:p-16">
    <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
      <div>
        ...
        <p className="mt-2 text-sm text-slate-600">
          Sammanstallningen bygger pa verkliga auditsvar. Negativa resultat utan full tackning maste tolkas forsiktigt
          och granskas manuellt.
        </p>
      </div>
      <div
...
export const ManualGateStep: React.FC<ManualGateStepProps> = ({
  ...
  <section className="min-h-[560px] space-y-8 p-10 md:p-16">
    <div>
      ...
      <p className="mt-2 text-sm text-slate-600">
        Detta steg ersatter automatisk signering. Beslutsstodet far inte behandlas som slutligt utan manuell verifiering,
        dokumentbedomning och juridisk kontroll.
      </p>
    </div>
    ...
    <div className="grid gap-4 md:grid-cols-2">
      ...
      <div className="rounded-3xl border border-rose-200 bg-rose-50 p-6 text-sm text-rose-800">
        ...
        <p className="mt-3">
          Ingen automatisk ansokan, inget slutligt ja/nej och ingen juridisk slutsats far produceras utan manniska i
          loopen. Resultat med fallback, stickprov eller oklara kallor ska eskaleras till manuell granskning.
        </p>
    ...
    <div className="rounded-3xl border border-slate-200 bg-white p-6">
      ...
      <p className="mt-3 text-sm text-slate-700">
        Det har steget stoppar medvetet fore inskickning. Granskaren maste nu ta over, lasa underlagen och fatta beslut
        om fortsatt handlaggning.
      </p>
    </div>
    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:justify-between">
      ...
      <button
        type="button"
        onClick={onReset}
        className="rounded-2xl bg-emerald-600 px-5 py-4 text-xs font-black uppercase tracking-[0.14em] text-white"
      >
        Ny korning
      </button>
    </div>
