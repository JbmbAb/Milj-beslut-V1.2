...
async function createUiFromSpec(prompt, spec) {
  ...
  page.name = spec.title ? spec.title : "AI UI";
  ...
  const meta = createText("Generated by Miljobeslut AI", 11, "Regular");
  meta.fills = [{ type: "SOLID", color: { r: 0.42, g: 0.47, b: 0.56 } }];
