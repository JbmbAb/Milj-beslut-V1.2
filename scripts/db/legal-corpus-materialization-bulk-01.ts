...
const DOCUMENTS: readonly DocumentSpec[] = [
  {
    ...
    mimeType: 'text/html',
    downloadManifestId:
      'download-manifest-pilot-regeringskansliet-sfs-2013-251-2a8d3773-f7f7-4b95-8655-d2502d095954-98b66a7299df09a6',
  ...
  },
  {
    ...
    mimeType: 'text/html',
    downloadManifestId:
      'download-manifest-pilot-regeringskansliet-sfs-2020-614-055a39bd-bd6e-4e8f-bf33-70b3f05d8662-f00d3cd19b32a7a7',
  ...
  },
  {
    ...
    mimeType: 'text/html',
    downloadManifestId:
      'download-manifest-pilot-regeringskansliet-sfs-2010-900-e0d88b92-558b-4178-a881-31ac5ff96a2d-874b3a966c7650c6',
  ...
  },
  {
    ...
    mimeType: 'text/html',
    downloadManifestId:
      'download-manifest-pilot-regeringskansliet-sfs-2011-338-a231ceaa-77fc-4ae4-80b4-2237730e1c25-2e3dfbd878587842',
  ...
  },
  {
    ...
    mimeType: 'text/html',
    downloadManifestId:
      'download-manifest-pilot-regeringskansliet-sfs-1998-899-dfba2f33-1f58-4021-aa3e-8a2d330b9ec1-3e069dc1f5e52e8f',
  ...
  },
  {
    ...
    quarantineId: 'b86f5d5d-a3c0-4008-8698-511e816f538d',
    mimeType: 'text/html',
    downloadManifestId:
      'download-manifest-pilot-hav-hvmfs-2016-17-47a45b8f-6894-40bf-ab78-49aa03ed44f5-52bfbac0de7cff5c',
    downloadManifestDigest: '52bfbac0de7cff5c78c429992cf2667c1994149745a7ae551277241f50d3b726',
    structureKind: 'standard',
    sourceFamily: 'HVMFS',
    sourceType: 'AGENCY_GENERAL_ADVICE',
    title: 'HVMFS 2016:17 - Små avloppsanordningar för hushållsspillvatten',
  },
  {
    sourceId: 'sgu-well-drilling-guidance',
    ...
    quarantineId: '1a6961db-c0a1-4268-b838-d4ba744e37b6',
    mimeType: 'text/html',
    downloadManifestId:
      'download-manifest-pilot-sgu-well-drilling-guidance-d4a65f06-9b20-4a2c-a702-36b02c4154df-e643acd1accd0309',
    downloadManifestDigest: 'e643acd1accd0309baa1c3d13c691c918116a32ddac134f88762839bfc2dd177',
    structureKind: 'standard',
    sourceFamily: 'SGU',
    sourceType: 'AGENCY_GUIDANCE',
    title: 'Vägledning för att borra brunn',
  },
];
...
async function materializeOnce(
  ...
  const downloadManifestRef = {
    id: spec.downloadManifestId,
    content_hash: { algorithm: 'sha256' as const, digest: spec.downloadManifestDigest },
  };
...
async function runSource(spec: DocumentSpec): Promise<SourceReport> {
  ...
  try {
    ...
    console.log(
      ...
      'admitted /',
      report.chunks_rejected,
      'rejected —',
      admission.document_status,
    );
    ...
    report.replay_same_materialization_id =
    ...
    console.log(
      'replay:',
      report.replay_same_materialization_id ? 'same identity' : 'IDENTITY DRIFT',
      '/',
      chunkCount1,
      'vs',
      chunkCount2,
    ...
    report.status =
      report.replay_same_materialization_id &&
      report.replay_same_chunk_count &&
      !report.replay_duplicate_rows &&
      !report.replay_identity_drift
        ? 'PROVEN'
        : 'PARTIAL';
    return report;
  } catch (error) {
...
async function main() {
  ...
  const totalChunkRows = reports.reduce(
    (sum, r) => sum + (typeof r.governed_chunk_rows === 'number' ? r.governed_chunk_rows : 0),
    0,
  );
