...
async function main() {
    ...
    `, req.id, req.requirementCode, req.caseId, req.documentId, req.projectId, req.sourceType, req.category, req.subcategory, req.requirementTextQuote, req.interpretedRequirement, req.level, req.verificationStatus, req.updatedAt, req.createdAt);
