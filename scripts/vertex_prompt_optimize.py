...
def launch_prompt_optimization_job(project_id, bucket_uri, container_image, location):
    ...
    output_path = f"gs://{bucket_name}/alphaevolve/list_deduplication/prompt_opt_results"
...
def main():
    parser = argparse.ArgumentParser(description="Launch Prompt Optimization on Vertex AI")
    parser.add_argument("--project", required=True, help="GCP Project ID")
    parser.add_argument("--bucket", required=True, help="GCS Bucket Name or URI (e.g. gs://bucket)")
    parser.add_argument("--container", required=True, help="Container image URI (e.g. gcr.io/...)")
