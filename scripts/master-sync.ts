...
async function main() {
  ...
  try {
    ...
    try {
      const ingestCmd = `npx tsx scripts/import/idempotent-ingest.ts --input="C:\\Users\\jimmy\\Desktop\\MiljoBeslut_Produktdata\\Mallar_Ingest\\manifest.csv" --project-id=${project.id} --organisation-id=${org.id} --attachments-dir="C:\\Users\\jimmy\\Desktop\\OutlookExport"`;
