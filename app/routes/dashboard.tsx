...
export const meta: MetaFunction = () => {
  return [
    { title: 'Miljöbeslut.se - Dashboard - Verifierad Status' },
      ...
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
               <div className="text-right">
                  ...
                  <div className="text-2xl font-mono font-bold text-white">{graphStats.totalEdges} relationer</div>
               </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {completion.categories.slice(0, 3).map((cat, idx) => (
            <div key={cat.name} className={`glass p-6 rounded-2xl border border-white/5 animate-scaleIn`} style={{ animationDelay: `${idx * 0.1}s` }}>
               ...
               <div className="flex items-end justify-between">
                  ...
                  <div className="text-xs text-white/40">{cat.done} / {cat.total} Klara</div>
               </div>
