/**
 * evaluate-compliance-rules.usecase.ts
 *
 * Clean Architecture Use Case for Environmental Code & Waste Compliance Rule Engine.
 * Evaluates strict thresholds and spatial indicators to decide compliance requirements,
 * offloading hard numeric/deterministic logic from LLM.
 */
...
export class EvaluateComplianceRulesUseCase {
  /**
   ...
   */
  evaluateProjectCompliance(metrics: ComplianceMetrics): RuleEngineResult {
