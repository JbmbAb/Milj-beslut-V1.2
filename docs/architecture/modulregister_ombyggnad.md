...
| Modulgrupp                        | Primara sokvagar                                                                        | Status      | Motiv                                                                       | Rekommenderad atgard                                                       |
| --------------------------------- | --------------------------------------------------------------------------------------- | ----------- | --------------------------------------------------------------------------- | -------------------------------------------------------------------------- |
| Arkiverat utvecklingsmaterial     | (borttaget från repo; se git-historik)                                                  | `ARKIVERAT` | Examens-/utvecklingsmaterial fanns i separat spår; pekar inte längre på lokala sökvägar. | Använd git-historik vid behov; inget aktivt `archive/projekt/`.            |
| QA-, analysis- och legal-underlag | `docs/qa/*`                                                                               | `BEHALLAS`  | Viktigt for spårbarhet, granskning och juridisk hallbarhet.                 | Behall som revisionsunderlag; se `docs/qa/README.md`.                      |
