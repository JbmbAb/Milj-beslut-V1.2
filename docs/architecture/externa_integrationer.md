...
Miljöbeslut.se är byggt för att vara ett centralt nav för svensk miljöintelligence. Plattformen aggregerar data från en mängd olika nationella källor via både GIS-tjänster och REST-API:er.
